...
public class SuperPacman extends RPG {
	...
	private  DiscreteCoordinates[] PLAYER_SPAWN_POSITION; = {new DiscreteCoordinates(2,10), 
	...
	public boolean begin(Window window, FileSystem fileSystem) {
		...
		if (super.begin(window, fileSystem)) {
			...
			player = new SuperPacmanPlayer(area, getSPAWN(this) );
